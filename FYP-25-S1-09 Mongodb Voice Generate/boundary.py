...
class TeacherAssignmentBoundary:
    ...
    def view_submissions(classroom_id, assignment_id):
        ...
        # Convert due_date string to datetime object if needed
        if "due_date" in assignment and isinstance(assignment["due_date"], str):
            try:
                ...
                try:
                    # Try alternative format if ISO fails
        ...
        for submission in submissions:
            ...
            submission.setdefault("_id", ObjectId())
            ...
            if isinstance(submission["submitted_at"], str):
                try:
                    submission["submitted_at"] = datetime.strptime(
                        submission["submitted_at"], "%Y-%m-%d %H:%M:%S"
                    )
                except ValueError:
